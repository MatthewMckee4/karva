...
def test_circular_fixture_dependency(test_env: TestEnv) -> None:
    test_env.write_files(
        [
            *get_source_code("pass"),
            (
                ...
                @fixture
                def calculator_a(calculator_b: Calculator) -> Calculator:
                    print("Calculator A initialized")
                    return Calculator()

                @fixture
                def calculator_b(calculator_a: Calculator) -> Calculator:
                    print("Calculator B initialized")
                    return Calculator()""",
            ),
            (
                ...
                def test_circular_dependency(calculator_a: Calculator) -> None:
                    assert calculator_a.add(1, 2) == 3""",
            ),
        ],
    )
...
----- stdout -----
error[fixture-not-found] in <temp_dir>/tests/test_calculator.py
| Fixture calculator_a not found
-------------
Error tests: 1

----- stderr -----
ERROR Circular dependency detected between fixtures: calculator_a -> calculator_b -> calculator_a"""
    )
    test_env.cleanup()


def test_self_dependent_fixture(test_env: TestEnv) -> None:
    test_env.write_files(
        [
            *get_source_code("pass"),
            (
                ...
                @fixture
                def self_dependent(self_dependent: Calculator) -> Calculator:
                    print("Self dependent calculator initialized")
                    return Calculator()""",
            ),
            (
                "tests/test_calculator.py",
                ...
                def test_self_dependency(self_dependent: Calculator) -> None:
                    assert self_dependent.add(1, 2) == 3""",
            ),
        ],
    )
...
----- stdout -----
error[fixture-not-found] in <temp_dir>/tests/test_calculator.py
| Fixture self_dependent not found
-------------
Error tests: 1

----- stderr -----
ERROR Circular dependency detected between fixtures: self_dependent -> self_dependent"""
    )
