...
</dd><dt id="karva-test--failed-first"><a href="#karva-test--failed-first"><code>--failed-first</code></a>, <code>--ff</code> <i>failed-first</i></dt><dd><p>Run tests that failed in the previous run before other selected tests</p>
<p>May also be set with the <code>KARVA_FAILED_FIRST</code> environment variable.</p><p>Possible values:</p>
<ul>
<li><code>true</code></li>
<li><code>false</code></li>
