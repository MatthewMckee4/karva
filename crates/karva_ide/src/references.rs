...
mod tests {
    ...
    fn finds_cross_file_references_with_optional_declaration() {
        ...
        let target = crate::fixture_occurrence(&analysis, offset(parameter, "database"))
    ...
    fn keeps_shadowed_provider_references_separate() {
        ...
        let nested_target =
            crate::fixture_occurrence(&nested_analysis, offset(nested_test, "database"))
        ...
        let root_target =
            crate::fixture_occurrence(&provider_analysis, offset(nested_provider, "database):"))
    ...
    fn reports_custom_public_name_ranges() {
        ...
        let target = crate::fixture_occurrence(&analysis, offset(source, "database\")\ndef test"))
