//! Environment variables read once and shared across Karva processes.
...
#[derive(Debug)]
/// Failure to resolve Karva's effective worker parallelism.
pub enum MaxParallelismError {
    /// A configured value was not a positive integer.
    InvalidValue {
    ...
    InvalidUnicode {
        /// Environment variable containing invalid Unicode.
        name: &'static str,
    },

    /// Platform parallelism detection failed when no override was configured.
    AvailableParallelism(io::Error),
}

#[derive(Debug, Clone, PartialEq, Eq)]
/// Invalid boolish environment-variable value.
pub enum BoolishEnvVarError {
    /// Unicode value did not match a supported true or false literal.
    InvalidValue {
        /// Environment variable containing the invalid value.
        name: &'static str,

        /// Unsupported boolish value.
        value: String,
    },

    /// Value could not be decoded as Unicode.
    InvalidUnicode {
        /// Environment variable containing invalid Unicode.
        name: &'static str,

        /// Lossy rendering of invalid value for diagnostics.
        value: String,
    },
}
...
/// Reads an optional environment variable using common boolish spellings.
...
/// Resolves worker parallelism from Karva, Rayon, then platform defaults.
