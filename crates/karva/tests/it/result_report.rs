      ...
      "tests": [
        ...
        },
        {
          ...
          "diagnostic": {
            ...
            "rendered": "error[test-failure]: Test `test_fail` failed\n  --> test_report.py:10:5/n10 | def test_fail():\n   |     ^^^^^^^^^/ninfo: Test failed here\n  --> test_report.py:12:5/n12 |     assert False\n   |     ^^^^^^^^^^^^\n\n"
          },
          "attempts": [
            {
              "attempt": 1,
          ...
          "attempts": [
            {
              ...
              "diagnostic": {
                ...
                "rendered": "error[test-failure]: Test `test_flaky` failed\n  --> test_report.py:21:5/n21 | def test_flaky():\n   |     ^^^^^^^^^^/ninfo: Test failed here\n  --> test_report.py:26:5/n26 |     assert count >= 1\n   |     ^^^^^^^^^^^^^^^^^\n\n"
              }
            },
            {
              "attempt": 2,
          ...
          "attempts": [
            {
              ...
              "diagnostic": {
                ...
                "severity": "error",
                "message": "Test `test_flaky` failed",
                "rendered": "error[test-failure]: Test `test_flaky` failed\n --> test_flaky.py:4:5/n4 | def test_flaky():\n  |     ^^^^^^^^^^/ninfo: Test failed here\n --> test_flaky.py:5:5/n5 |     assert os.environ[/"KARVA_ATTEMPT/"] == /"2/"\n  |     ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n\n"
              }
            },
            {
              "attempt": 2,
