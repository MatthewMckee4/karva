...
pub fn hover_markup_kind(capabilities: &ClientCapabilities) -> MarkupKind {
    capabilities
        .text_document
        .as_ref()
...
pub fn supports_diagnostic_related_information(capabilities: &ClientCapabilities) -> bool {
    capabilities
        .text_document
        .as_ref()
...
pub fn supports_hierarchical_document_symbols(capabilities: &ClientCapabilities) -> bool {
    capabilities
        .text_document
        .as_ref()
