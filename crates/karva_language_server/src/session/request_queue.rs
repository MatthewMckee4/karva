...
impl RequestQueue {
    ...
    pub fn register_outgoing(&mut self, id: RequestId) {
        self.outgoing.insert(id);
    }

    pub fn complete_outgoing(&mut self, id: &RequestId) -> bool {
...
impl Incoming {
    ...
    pub fn cancellation_token(&self, id: &RequestId) -> Option<RequestCancellationToken> {
    ...
    pub fn complete(&mut self, id: &RequestId) -> Option<(Instant, String)> {
        self.pending
            .remove(id)
