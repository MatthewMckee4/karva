...
impl WalkDirectoryBuilder {
    pub fn new<W>(path: impl AsRef<Utf8Path>, walker: W) -> Self
    where
    ...
    pub fn add(mut self, path: impl AsRef<Utf8Path>) -> Self {
...
pub(super) mod tests {
    ...
    use crate::system::{
        FileType, Utf8PathBuf,
        walk_directory::{DirectoryEntry, Error},
    };
    ...
    impl DirectoryEntryToString {
        pub(crate) fn new(root_path: Utf8PathBuf) -> Self {
            Self {
                root_path,
